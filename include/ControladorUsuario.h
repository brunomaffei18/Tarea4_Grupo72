...
public:
   static ControladorUsuario* getInstancia();
     bool altaCliente(std::string nickname, std::string contrasena, std::string nombre, std::string email,std::string apellido, std::string documento);
        ...
        void altaCasa(std::string direccion, std::int numeroPuerta, std::int superficie, std::int anoConstruccion, std::bool esPH, TipoTecho techo);
        void altaApartamento(std::string direccion, std::int numeroPuerta, std::int superficie, std::int anoConstruccion, std::int piso, std::bool tieneAscensor, std::float gastosComunes);
