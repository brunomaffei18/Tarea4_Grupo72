OBJETOS = AdminsitraPropiedad.o Apartamento.o CargaDatos.o Casa.o \
...
AdminsitraPropiedad.o: DTFecha.o Inmueble.o Inmobiliaria.o Publicacion.o ./include/AdminsitraPropiedad.h ./src/AdminsitraPropiedad.cpp
	$(CC) $(OPCIONES) ./src/AdminsitraPropiedad.cpp -o AdminsitraPropiedad.o
